package top.cloudtour.cloudstudy.service.jobhandler;
...
import top.cloudtour.cloudstudy.messagesdk.service.MessageProcessAbstract;
...
public class CoursePublishTask extends MessageProcessAbstract {
    ...
    public void generateCourseHtml(MqMessage mqMessage,long courseId){
        ...
        if(file == null){
            CloudStudyException.cast("课程静态化异常");
        }
        //上传静态化页面
