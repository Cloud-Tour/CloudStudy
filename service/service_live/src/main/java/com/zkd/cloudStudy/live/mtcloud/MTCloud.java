...
package com.zkd.cloudStudy.live.mtcloud;


import com.zkd.cloudStudy.live.mtcloud.utils.MD5Util;
...
public class MTCloud {
     ...
     * 合作方ID： 合作方在欢拓平台的唯一ID
     */
    public String openID = "48745";

    /**
     * 合作方秘钥： 合作方ID对应的参数加密秘钥
     */
    public String openToken = "01064baff576505bc4cdded225646fa7";
