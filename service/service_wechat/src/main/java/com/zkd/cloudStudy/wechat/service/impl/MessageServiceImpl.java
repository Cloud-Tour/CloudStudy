...
import com.zkd.cloudStudy.wechat.service.MessageService;
...
public class MessageServiceImpl implements MessageService {
    ...
    public void pushPayMessage(long l) {
        String openid = "ovs6N56gwVN6ijnjDSmSHu09Udis";
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser(openid)//要推送的用户openid
                .templateId("eso0mmUl9prnGTCTtKbgCgiZLARADyt8qlwJyhs69XM")//模板id
                .url("https://55n84z4845.zicp.fun/#/pay/"+l)//点击模板消息要访问的网址
                .build();
